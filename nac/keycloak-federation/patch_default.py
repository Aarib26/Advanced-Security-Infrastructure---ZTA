...
def main():
    ...
    window = content[idx1:idx1+250]
    if "-sql" not in window:
        print("ERROR: anchor 1 context mismatch"); print(repr(window)); sys.exit(1)
    ...
    if mode == "--check":
        print("\n=== Will insert after 'files' ==="); print(INSERT_1)
        print("=== Will insert after Auth-Type PAP block ==="); print(INSERT_2)
